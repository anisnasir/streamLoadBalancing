...
/**
 * An atomic item in the stream. An item is composed by a timestamp and a line of text. The timestamp represents the position in the stream, the text is the
